...
import (
	...
	"github.com/ampchain/go-amp/xvm/compile"
	"github.com/ampchain/go-amp/xvm/debug"
	"github.com/ampchain/go-amp/xvm/exec"
	"github.com/ampchain/go-amp/xvm/runtime/emscripten"
	gowasm "github.com/ampchain/go-amp/xvm/runtime/go"
)
...
// 优先查找跟AmpChain同级目录的二进制，再在PATH里面找
