...
import (
	...
	ledgerlib "github.com/ampchain/go-amp/ledger"
	xpb "github.com/ampchain/go-amp/pb"
...
// basedir: data/blockchain/amper/native/driver
// tree:
// .
// |____math_1.0
// | |____bin
...
func (gscf *GeneralSCFramework) launchOne(desc *xpb.NativeCodeDesc, status nativeCodeStatus) (*standardNativeContract, error) {
	...
	if err != nil {
		...
		// 如果是AmpChain重启后的启动失败，只打日志来标明错误，需要重新部署或者手动检查错误
